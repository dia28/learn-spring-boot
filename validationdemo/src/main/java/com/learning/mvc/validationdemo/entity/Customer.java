package com.learning.mvc.validationdemo.entity;

import com.learning.mvc.validationdemo.validation.CourseCode;
...
public class Customer {
    ...
    @CourseCode(value = "MAL", message = "must start with MAL")
